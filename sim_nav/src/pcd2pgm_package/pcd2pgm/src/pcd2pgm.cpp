...
//最小和最大高度
double thre_z_min = -10000000;
double thre_z_max = 100000000;
int flag_pass_through = 0;
double map_resolution = 5;
double thre_radius = 100000000;
double max_accept_delta_z = 0.1;
//半径滤波的点数阈值
int thres_point_count = 0;
...
int main(int argc, char **argv) {
  ...
  std::cout << "filenameL: "<< pcd_file<<std::endl;
